export const profile = {
  ...
  bio:
    ...
    "I'm a Product Manager driven by creating delightful and intuitive user experiences. I blend innovation with user-centric design — explore my projects and explorations below.",
